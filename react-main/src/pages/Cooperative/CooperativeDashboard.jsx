...
const CooperativeDashboard = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      {/* Sidebar */}
      <div className="w-full md:w-64 bg-green-800 text-white flex flex-col">
        <div className="p-6">
        ...
        <nav className="mt-2 flex-1">
          <Link to="/cooperative/dashboard" className="block px-6 py-3 bg-green-900 border-l-4 border-green-400">
            Tableau de bord
          </Link>
          <Link to="/cooperative/products" className="block px-6 py-3 hover:bg-green-700 transition">
            Mes Produits
          </Link>
        </nav>
        <div className="p-4 border-t border-green-700">
          <button onClick={handleLogout} className="flex items-center gap-2 w-full text-left px-2 py-2 hover:bg-green-700 rounded transition">

...
const RegisterCooperative = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 bg-gray-50 relative overflow-hidden">
      ...
      {/* Main Card */}
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden relative z-10 border border-gray-100 mt-10 mb-10">

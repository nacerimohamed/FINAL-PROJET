...
const PROVINCES = [
  { id: "Midelt", label: "ميدلت", labelFr: "Midelt", center: [75, 50],
  ...
  { id: "Zagora", label: "زاكورة", labelFr: "Zagora", center: [74, 74],
  ...
  { id: "Tinghir", label: "تنغير", labelFr: "Tinghir", center: [72, 74],
  ...
  { id: "Ouarzazate", label: "ورزازات", labelFr: "Ouarzazate", center: [70, 64],
  ...
  { id: "Errachidia", label: "الرشيدية", labelFr: "Errachidia", center: [64, 71],
            ...
            {PROVINCES.map((province) => (
              ...
              >
                ...
                <svg viewBox="0 0 150 150" style={{ width: "100%", maxWidth: 130, display: "block" }}>
                  ...
                  />
                  {renderDots(counts[province.id], province.center)}
                </svg>

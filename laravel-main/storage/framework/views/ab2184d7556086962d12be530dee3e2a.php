...
<body>
    <div class="container">
        ...
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> Plateforme Coopérative. Tous droits réservés.
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\elmaa\OneDrive\Bureau\COOP - Copie - Copie (2)\FINAL-PROJET\laravel-main\resources\views/emails/reset_password.blade.php ENDPATH**/ ?>